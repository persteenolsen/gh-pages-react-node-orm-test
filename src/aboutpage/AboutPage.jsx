			...
			<div className="row">
			 ...
			 <div className="col-xs-auto col-md-auto" >
			  ...
			  <h3>Description</h3>
               ...
               This React SPA Client work together with a secure Node.js Express Web API using Sequelize ORM and JWT access tokens serving as a Role based Membership System. Some older Browsers like IE 11 are mostly supported
			   <br/><br/>
               ...
               <b>DevOps tricked by commit</b>
			   <ul>
				  <li>The source code at GitHub</li>
